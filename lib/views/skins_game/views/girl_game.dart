...
class GirlSkin extends StatelessWidget {
  static const routeName = '/GirlSkin';
  GirlSkin({super.key});
      ...
      builder: (controller) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('Girl Skin', style: AppTheme.whiteBig),
            centerTitle: true,
          ),
          body: (controller.girl['Girls'] == null)
              ? Center(
                    ...
                    children: [
                      Obx(() => Container(
                            ...
                            child: controller.isCorrect.value == true
                                ? CachedNetworkImage(
                                    imageUrl: controller.correctImages.value,
                                    height: 300,
                                    placeholder: (ctx, url) =>
                            ...
                            child: controller.isCorrect.value == false
                                ? GestureDetector(
                                    onTap: () {
                                      ...
                                      print(gemsController.gemValue.value);
                                      if (gemsController.gemValue.value < 150) {
                                        Get.back();
